...
SECRET_KEY = '*jwh2*@bk(=#nyz+a!xw_lnc@st8oz+sr=t$erppzl&nkz4n08'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
DEFAULT_FROM_EMAIL = 'Python ecommerce <ianbritosr@gmail.com>'

MANAGERS = (("ianbritosr@gmail.com", 'Ian Rocha'),)
